    ...
    return (
        <div className="bg-background-pattern bg-opacity-20 max-w-none">
            <div className="px-10 font-display bg-white bg-opacity-90">
                <h2 className="text-center text-2xl text-orange font-bold p-10">Aktualizuj dane zwierzęcia</h2>
                {showPopup && <SuccessPopup message="Aktualizacja pomyślna. Dziękujemy za wprowadzenie zmian."/>}
                <form onSubmit={(e) => onSubmit(e)} className="w-full max-w-lg m-auto pb-5">
                    ...
                    <button type="submit"
                        ...
                        <p className="py-15 justify-center text-base	 text-center text-brown font-medium	">Aktualizuj</p>
                    </button>
