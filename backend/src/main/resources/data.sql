...
INSERT INTO animals(name,information,species,sex,age,birth_date,animal_status,sterilized,vaccinated,kids_friendly,couch_potato,needs_activeness,cats_friendly,dogs_friendly,available_for_walk,user_id) VALUES ('Majster','Friendly and loves to play fetch','DOG','MALE','ADULT','2019-01-01','READY_FOR_ADOPTION',true,true,true,true,true,true,true,true,2);
INSERT INTO animals(name,information,species,sex,age,birth_date,animal_status,sterilized,vaccinated,kids_friendly,couch_potato,needs_activeness,cats_friendly,dogs_friendly,available_for_walk,user_id) VALUES ('ChinkiChinki','Friendly and loves to play fetch','DOG','MALE','ADULT','2019-01-01','READY_FOR_ADOPTION',true,true,true,true,true,true,true,true,3);
